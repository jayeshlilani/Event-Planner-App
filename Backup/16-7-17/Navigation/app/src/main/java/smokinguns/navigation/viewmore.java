...
public class viewmore extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String webViewUrl ="https://www.youtube.com/user/smokingunsetc/videos?sort=dd&view=0&shelf_id=0";
    ...
    private void setUpWebView() {
        ...
        webView.setWebViewClient(new viewmore.MyWebViewClient());
