        ...
        try{
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (c19.isChecked())
                        book = book + c19.getText().toString() + "\n";
                    if (c20.isChecked())
                        book = book + c20.getText().toString() + "\n";
                    if (c21.isChecked())
                        book = book + c21.getText().toString() + "\n";
                    if (c22.isChecked())
                        book = book + c22.getText().toString() + "\n";
                    if (c23.isChecked())
                        book = book + c23.getText().toString() + "\n";
                    if (c24.isChecked())
                        book = book + c24.getText().toString() + "\n";
                    if (c25.isChecked())
                        book = book + c25.getText().toString() + "\n";
                    if (c26.isChecked())
                        book = book + c26.getText().toString() + "\n";
