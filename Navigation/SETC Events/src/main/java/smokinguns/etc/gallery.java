...
public class gallery extends AppCompatActivity implements View.OnClickListener{
  ...
  private static WebView webView;
    ...
    private static final String webViewUrl ="https://www.facebook.com/pg/Smokingunsetc/photos/?tab=albums";
    @Override
...
//        String url = "https://www.facebook.com/pg/Smokingunsetc/photos/?tab=albums";
//
//        wv1.getSettings().setLoadsImagesAutomatically(true);
//        wv1.getSettings().setJavaScriptEnabled(true);
//        wv1.setScrollBarStyle(SCROLLBARS_INSIDE_OVERLAY);
//        wv1.loadUrl(url);
    }
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
            ...
            if (webViewProgressBar.isShown())
                webViewProgressBar.setVisibility(View.GONE);
            Toast.makeText(getApplicationContext(), "Unexpected SSL error occurred.Reload page again.", Toast.LENGTH_SHORT).show();
    ...
    private void LoadWebViewUrl(String url) {
        if (isInternetConnected())
            ...
            refresh.setVisibility(View.VISIBLE);
            Toast.makeText(getApplicationContext(), "Oops!! There is no internet connection. Please enable your internet connection.", Toast.LENGTH_LONG).show();
